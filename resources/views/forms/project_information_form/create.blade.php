...
@section('content')
    <section class="container">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="type_of_study" id="academicStaff"
                                value="academicStaff" checked>
                            <label class="form-check-label" for="academicStaff">Academic Staff Study</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="type_of_study" id="student"
                                value="student">
                            <label class="form-check-label" for="student">Student</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="type_of_study" id="other"
                                value="other">
                    ...
                    <div class="mb-3 row">
                        <div class="col">
                            ...
                            <div class="form-check">
                                <input name="study_involve_items" class="form-check-input" type="radio" value="yes">
                                <label class="form-label-small" for="flexCheckDefault2_0">Yes</label>
                            </div>
                            <div class="form-check">
                                <input name="study_involve_items" class="form-check-input" type="radio" value="no">
                            ...
                            <div id="ifYes4" style="display: none">
                                ...
                                <textarea value="InvIfYes" type="text" class="form-control" rows="8"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <div class="col">
                            ...
                            <div class="form-check">
                                <input name="will_partisipants_be_kept" class="form-check-input" type="radio"
                                    value="yes">
                    ...
                    <div class="mb-3 row">
                        <div class="col">
                            ...
                            <div class="form-check">
                                <input name="previous_research_project" class="form-check-input" type="radio"
                                    value="yes">
                            ...
                            <div id="ifYes7" style="display: none">
                                ...
                                <div class="col">
                                    <textarea name="previous_research_project_yes" value="" type="text" class="form-control" rows="8"
        ...
        <script>
            ...
            //form 4
            const ifYes4 = document.getElementById('ifYes4')
            document.querySelectorAll('input[name="study_involve_items"]').forEach((radio) => {
                radio.addEventListener('change', function() {

                    if (this.value === 'yes') {
                        ifYes4.style.display = 'block';
                    } else {
                        ifYes4.style.display = 'none';
                    }
                });
            });

            //form 5
            const ifYes5 = document.getElementById('ifYes5')
            document.querySelectorAll('input[name="will_partisipants_be_kept"]').forEach((radio) => {
                radio.addEventListener('change', function() {

                    if (this.value === 'yes') {
                        ifYes5.style.display = 'block';
                    } else {
                        ifYes5.style.display = 'none';
                    }
                });
            });

            //form 7
            const ifYes7 = document.getElementById('ifYes7')
            document.querySelectorAll('input[name="previous_research_project"]').forEach((radio) => {
                radio.addEventListener('change', function() {

                    if (this.value === 'yes') {
                        ifYes7.style.display = 'block';
                    } else {
                        ifYes7.style.display = 'none';
                    }
                });
            });
        </script>
